...
from uk_sponsor_pipeline.infrastructure import CachedHttpClient, CircuitBreaker, DiskCache, RateLimiter
...
class TestStage2AuthIntegration:
    ...
    def test_api_key_is_passed_to_session(self, tmp_path):
        ...
        stage1_csv.write_text(
            "Organisation Name,org_name_normalized,Town/City,County\n"
            "Test Company Ltd,test company,London,Greater London\n"
        )
