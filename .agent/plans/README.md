...
| --- | --- | --- | --- | --- |
| `.agent/plans/linear-delivery-plan.md` | Single ordered execution path with milestone requirements and acceptance criteria. | Active (`M7-B1`, `M7-B2` complete; `Next batch to execute: M7-B3`) | Jim + Codex | 2026-02-12 |
